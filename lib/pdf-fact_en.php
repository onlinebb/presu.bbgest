...
$html =
    '<table cellspacing="0" cellpadding="1" border="0">
        <tr>
            <td width="60%">&nbsp;</td>
            <td width="40%" style="color: #F95978; font-weight: bold; font-size: 20px;"><b>INVOICE</b></td>
        </tr>
    </table>
    <br><br>
    <table cellspacing="0" cellpadding="1" border="0">
    ...
    <table cellspacing="0" cellpadding="1" border="0">
        <tr>
            <td width="15%" style="color: #F95978; border: 1px solid #999999;">Receiver</td>
            <td width="30%" style="border-bottom: 1px solid #999999;">&nbsp;</td>
        </tr>
        <tr>
            <td width="15%" style="color: #999999; border-left: 1px solid #999999;">Contact</td>
        ...
        <tr>
            <td width="15%" style="color: #999999; border-left: 1px solid #999999;">Company</td>
        ...
        <tr>
            <td width="15%" style="color: #999999; border-left: 1px solid #999999;">Address</td>
        ...
        <tr>
            <td width="15%" style="color: #999999; border-left: 1px solid #999999;">Postal code</td>
        ...
        <tr>
            <td width="15%" style="color: #999999; border-left: 1px solid #999999; border-bottom: 1px solid #999999;">VAT number</td>
    ...
    <table cellspacing="0" cellpadding="1" border="0">
        <thead>
            <tr>
                <td width="15%" style="color: #F95978; border: 1px solid #999999;">CONCEPT</td>
...
$html .= '<tr><td colspan="3">&nbsp;</td></tr>
    ...
    <table cellspacing="0" cellpadding="1" border="0">
        <tr>
            <td width="20%" style="color: #F95978; border: 1px solid #999999;">Due date</td>
            <td width="20%">&nbsp;</td>
        </tr>
        <tr>
    ...
    <table cellspacing="0" cellpadding="1" border="0">
        <tr>
            <td width="20%" style="color: #F95978; border: 1px solid #999999;">Payment conditions</td>
            <td width="20%">&nbsp;</td>
        </tr>
        <tr>
            <td width="40%" colspan="2" style="color: #999999; border: 1px solid #999999; text-align: center">Bank transfer</td>
        </tr>
    </table>
    <br><br>
    <table cellspacing="0" cellpadding="1" border="0">
        <tr>
            <td width="20%" colspan="2" style="color: #F95978; border: 1px solid #999999;">Bank details (IBAN)</td>
